...
sprite_sheets_image = pygame.image.load("kirby teste final.png").convert_alpha()
...
for animation in animation_steps:
    ...
    for _ in range(animation):
        temp_img_list.append(sprite_sheet.get_images_from_spritesheets(step_counter, 24.9, 28, 3, azul))
        step_counter += 1
